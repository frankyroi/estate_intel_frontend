...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"login","method":"post","propertyName":false},"logout":false,"user":{"url":"me","method":"get","propertyName":"data"}},"_name":"local"}))
